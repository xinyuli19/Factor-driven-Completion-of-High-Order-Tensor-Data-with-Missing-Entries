...
for(number in 1:repeats){
  ...
  #计算误差指标
  rmse[1,1]<-rmse[1,1]+RMSE(X_hat,X_complete,0.025)
  rmse[1,2]<-rmse[1,2]+RMSE(X1,X_complete,0.025)
  rmse[1,3]<-rmse[1,3]+RMSE(X2,X_complete,0.025)
  rmse[1,4]<-rmse[1,4]+RMSE(X3,X_complete,0.025)
}
...
for(number in 1:repeats){
  ...
  #计算误差指标
  rmse[2,1]<-rmse[2,1]+RMSE(X_hat,X_complete,0.05)
  rmse[2,2]<-rmse[2,2]+RMSE(X1,X_complete,0.05)
  rmse[2,3]<-rmse[2,3]+RMSE(X2,X_complete,0.05)
  rmse[2,4]<-rmse[2,4]+RMSE(X3,X_complete,0.05)
}
...
for(number in 1:repeats){
  ...
  #计算误差指标
  rmse[3,1]<-rmse[3,1]+RMSE(X_hat,X_complete,0.075)
  rmse[3,2]<-rmse[3,2]+RMSE(X1,X_complete,0.075)
  rmse[3,3]<-rmse[3,3]+RMSE(X2,X_complete,0.075)
  rmse[3,4]<-rmse[3,4]+RMSE(X3,X_complete,0.075)
}
